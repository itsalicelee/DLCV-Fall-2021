...
def arg_parse():
    parser = argparse.ArgumentParser(description='DLCV_HW1_b07303024')
    ...
    parser.add_argument('--train_data',default="../hw1_data/p1_data/train_50/", type=str)
    parser.add_argument('--test_data',default="../hw1_data/p1_data/val_50/", type=str)
